...
/**
 * Community Designs Share validation schemas using Joi
 */
...
// Create community design share validation schema
const createCommunityDesignShareSchema = Joi.object({
  community_designs_id: commonValidations.community_designs_id,
  status: commonValidations.status
});

// Update community design share validation schema
const updateCommunityDesignShareSchema = Joi.object({
  id: Joi.number()
    .integer()
    .positive()
    .required()
    .messages({
      'number.base': 'Community Designs Share ID must be a number',
      'number.integer': 'Community Designs Share ID must be an integer',
      'number.positive': 'Community Designs Share ID must be a positive number',
      'any.required': 'Community Designs Share ID is required'
    }),
...
// Get community design share by ID validation schema
const getCommunityDesignShareByIdSchema = Joi.object({
  id: Joi.number()
    .integer()
    .positive()
    .required()
...
// Get all community design shares query validation schema
const getAllCommunityDesignSharesSchema = Joi.object({
  page: Joi.number()
    .integer()
    .min(1)
    .default(1)
