...
const { createVibeFundingCampaign, getAllVibeFundingCampaign, getVibeFundingCampaignById, updateVibeFundingCampaign, deleteVibeFundingCampaign, vibePayment } = require('../../controllers/vibe_funding_campaign.controller');
const { auth } = require('../../../middleware/auth');
const { validateBody, validateQuery, validateParams } = require('../../../middleware/validation');
const { createVibeFundingCampaignSchema, updateVibeFundingCampaignSchema, getVibeFundingCampaignByIdSchema, getAllVibeFundingCampaignSchema } = require('../../../validators/vibe_funding_campaign.validator');
