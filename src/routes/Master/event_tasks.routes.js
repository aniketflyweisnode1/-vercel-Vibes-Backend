...
const { createEventTaskSchema, updateEventTaskSchema, querySchema, idSchema, eventIdSchema } = require('../../../validators/event_tasks.validator');
const { createEventTask, getAllEventTasks, getEventTaskById, getEventTasksByAuth, updateEventTask, deleteEventTask, getEventTasksByEventId } = require('../../controllers/event_tasks.controller');
...
// Get event tasks by event ID (with auth)
router.get('/event/:eventId', auth, validateParams(eventIdSchema), validateQuery(querySchema), getEventTasksByEventId);
