...
const { createEventEntryTicketsOrder, getAllEventEntryTicketsOrders, getEventEntryTicketsOrderById, getEventEntryTicketsOrdersByAuth, updateEventEntryTicketsOrder, deleteEventEntryTicketsOrder, processPayment } = require('../../controllers/event_entry_tickets_order.controller');
...
router.post('/payment', auth, validateBody(processPaymentSchema), processPayment);
